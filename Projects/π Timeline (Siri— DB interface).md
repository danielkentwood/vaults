...
an iphone app that lets you tell Siri notes, log entries, calendar items.

It is a Siri interface for databases.

Ideally, you just say, Hey Siri.

- Siri comes online.
- You say "Tell timeline DOCUMENT_NAME to write MESSAGE."
- If there are multiple columns:
    - "Tell timeline DOCUMENT_NAME to write MESSAGE in COLUMN_X."
    - "Tell timeline DOCUMENT_NAME to write MESSAGE in COLUMN_Y."
- If you want to specify a different time than the current time:
    - "Tell timeline DOCUMENT_NAME to write MESSAGE in COLUMN_X at TIME_T"